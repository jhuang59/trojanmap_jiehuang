...
class TrojanMap {
 public:
  ...
  void TSP_aux(std::string start, std::vector<std::string> &location_list,std::vector<std::string> &curr_path,double &min_cost, std::vector<std::string> &min_path);
  void TSP_aux_trojanpath(std::vector<std::string> &location_list,std::vector<std::string> &curr_path, double &min_cost, std::vector<std::string> &min_path);
  std::vector<std::string> CalculateShortestPath_Dijkstra_helper(
    std::string location1_name, std::string location2_name, double gas_tank);
  std::vector<std::string> copyallelementbutIth(std::vector<std::string> nums,int i);
  std::vector<std::vector<std::string>> permutation_recursive(std::vector<std::string> &nums);
};
